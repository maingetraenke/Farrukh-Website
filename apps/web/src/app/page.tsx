...
const reasons = [
  {
    icon: MapPin,
    title: "Regional",
    text: "Aus Kitzingen — für Kitzingen und Umgebung.",
  },
  {
    icon: ShieldCheck,
    title: "Zuverlässig",
    text: "Pünktliche Lieferung, auf die du dich verlassen kannst.",
  },
  {
    icon: PackageSearch,
    title: "Große Auswahl",
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-2 md:items-center md:px-6 md:py-24">
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-md text-base text-muted-foreground">
                Wir sind ein regionaler Getränkelieferdienst aus Kitzingen.
                Sag uns, was du brauchst — wir liefern es dir zuverlässig
        ...
        <section className="border-b border-border bg-white">
          <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-4 py-10 md:grid-cols-4 md:px-6">
            {reasons.slice(0, 4).map((reason) => (
              <div key={reason.title} className="flex items-center gap-3">
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-xl text-center">
              <h2 className="text-3xl font-bold tracking-tight text-foreground">
                Warum <span className="text-primary">MainGetränke</span>?
              </h2>
              <p className="mt-2 text-muted-foreground">
        ...
        <section id="kontakt" className="scroll-mt-16 py-16 md:py-24">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-xl text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Wir sind für dich da — persönlich, schnell und
                unkompliziert.
              </p>
            </div>
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <div className="flex flex-col items-center gap-2 rounded-2xl border border-border bg-white p-6 text-center shadow-sm">
                ...
                <span className="text-muted-foreground text-sm">
                  Ruf uns an oder schreib uns — wir melden uns zeitnah
                  zurück.
                </span>
              </div>
            </div>
